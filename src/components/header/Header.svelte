...
>
  <img
    ...
    height="1080"
  />
  <div class="container relative max-w-4xl mx-auto pt-16 md:pt-32 text-center break-normal">
    <h1 class="text-black text-7xl md:text-9xl" style="font-family: cursive">{title}</h1>
  </div>
</header>
