  ...
  <div class="container max-w-6xl mx-auto flex items-center px-2 py-8">
    <div class="w-full mx-auto flex flex-wrap items-center">
      <div class="flex w-full md:w-1/2 justify-center md:justify-start text-white font-extrabold content-center">
        <a class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-125" href="/">
          <img class="w-20 h-20 rounded-full filter invert" src="/maze2.svg" alt="maze" width="80" height="80" />
        </a>
      </div>
